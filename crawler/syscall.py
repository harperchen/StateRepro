...
all_syscall = [
    ...
    "ioctl$BINDER_FREEZE",
    "ioctl$BINDER_GET_EXTENDED_ERROR",
    ...
    "ioctl$DRM_IOCTL_SYNCOBJ_FD_TO_HANDLE_FD",
    "ioctl$DRM_IOCTL_SYNCOBJ_FD_TO_HANDLE_SYNC_FILE",
    "ioctl$DRM_IOCTL_SYNCOBJ_HANDLE_TO_FD_FD",
    "ioctl$DRM_IOCTL_SYNCOBJ_HANDLE_TO_FD_SYNC_FILE",
    ...
    "ioctl$SW_SYNC_IOC_CREATE_FENCE",
    ...
    "setsockopt$MRT6_ADD_MFC",
    "setsockopt$MRT6_ADD_MFC_PROXY",
    "setsockopt$MRT6_ADD_MIF",
    "setsockopt$MRT6_ASSERT",
    "setsockopt$MRT6_DEL_MFC",
    "setsockopt$MRT6_DEL_MFC_PROXY",
    "setsockopt$MRT6_DEL_MIF",
    "setsockopt$MRT6_DONE",
    "setsockopt$MRT6_FLUSH",
    "setsockopt$MRT6_INIT",
    "setsockopt$MRT6_PIM",
    "setsockopt$MRT6_TABLE",
    "setsockopt$MRT_ADD_MFC",
    "setsockopt$MRT_ADD_MFC_PROXY",
    "setsockopt$MRT_ADD_VIF",
    "setsockopt$MRT_ASSERT",
    "setsockopt$MRT_DEL_MFC",
    "setsockopt$MRT_DEL_MFC_PROXY",
    "setsockopt$MRT_DEL_VIF",
    "setsockopt$MRT_DONE",
    "setsockopt$MRT_FLUSH",
    "setsockopt$MRT_INIT",
    "setsockopt$MRT_PIM",
    ...
    "write$char_usb",
    "write$damon_attrs",
    "write$damon_contexts",
    "write$damon_init_regions",
    "write$damon_monitor_on",
    "write$damon_schemes",
